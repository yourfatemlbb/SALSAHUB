...
local logs = {"Build V7.0 | GUI parent: " .. tostring(uiParentName)}
...
brand.ZIndex = 4
local subtitle = label(header, "Anime Dice  •  V7.0", UDim2.fromOffset(210, 20), UDim2.fromOffset(64, 34), 11, C.muted, Enum.Font.GothamMedium)
subtitle.ZIndex = 4
...
log("SALSAHUB V7.0 dibuka • memuat core...")

-- ============================================================
-- RayVoid front-end (V7.0)
-- ============================================================
...
task.spawn(function()
    ...
    local okWindow, Window = pcall(function()
        return Rayfield:CreateWindow({
            ...
            LoadingSubtitle = "Anime Dice • V7.0",
            ShowText = "SALSAHUB",
            Theme = "Amethyst",
            SideTabs = true,
            ToggleUIKeybind = "K",
    ...
    notify("SALSAHUB", "RayVoid-style UI loaded • backend SALSAHUB V7.0", 4)
    log("RayVoid front-end aktif • Theme Amethyst • SideTabs")
end)
