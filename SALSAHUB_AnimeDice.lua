...
local logs = {"Build V6.4 | GUI parent: " .. tostring(uiParentName)}
...
brand.ZIndex = 4
local subtitle = label(header, "Anime Dice  •  V6.4", UDim2.fromOffset(210, 20), UDim2.fromOffset(64, 34), 11, C.muted, Enum.Font.GothamMedium)
subtitle.ZIndex = 4
...
log("SALSAHUB V6.4 dibuka • memuat core...")
